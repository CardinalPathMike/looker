     ...
     html:
      <div class="vis" >
        ...
        <div style="width=100% font-size:2em; background-image: linear-gradient(to right, #1b1662, #000000, #91aa2d); color:#ffffff">
          ...
          <span style="color: #000000 font-size:2em"><b>&nbsp; vs </b></span>
          <span style="color: #8C75F5font-size:2em "><b>&nbsp;{{ cross_channel_custom_timeframe.first_date_period_b._rendered_value }} - {{ cross_channel_custom_timeframe.last_date_period_b._rendered_value }}</b></span>
        </div>
    </div>;;
  }
