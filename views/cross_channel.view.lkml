...
view: cross_channel {
  ...
  dimension: creative_message_image {
    ...
    html:
              ...
              <img src="https://storage.googleapis.com/peloton_creatives/mjtcwyt531.png" width="255">
  ...
  measure: spend_filtered_6s {
    type: sum
    value_format_name: usd_0
    sql: ${TABLE}.Spend ;;
    filters: [dimension_grouping: "6s"]
    }

  measure: spend_filtered_7s_15s {
    type: sum
    value_format_name: usd_0
    sql: ${TABLE}.Spend ;;
...
##  Tread Sales
  ...
  measure: Men_Banner {
    ...
    <div class="vis">
      <div class="vis-single-value" style="font-size:30px; background-image: linear-gradient(to right, #1b1662, #000000, #91aa2d); color:#ffffff">
      <p style="float:left;"><font color="#FFFFFF"><center><b>Men</b></font></p>
      </div>
      </div>;;
  }
