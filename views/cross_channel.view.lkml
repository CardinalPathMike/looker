...
view: cross_channel {
  ...
  dimension: creative_message_image {
    ...
    html:
              ...
              {% elsif creative_message._value contains "wherever_you_call_home" and creative_variation._value contains "mjpaa" %}
              ...
              {% elsif creative_message._value == "camila_music" and creative_variation._value contains "mjblar6t554" %}
              <img src="https://storage.googleapis.com/peloton_creatives/carl_her_mommy_.png" width="255">
